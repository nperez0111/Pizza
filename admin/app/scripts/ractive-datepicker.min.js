                                            ...
                                            "f": [ {
                                                ...
                                                "f": [ {
                                                    ...
                                                    "m": [ {
                                                        ...
                                                        "n": 50,
                                                        "x": {
                                                            "r": [ "current.year", "current.month", "date", "." ],
                                                            "s": "_2 instanceof Date&&_2.getFullYear()==_0&&_2.getMonth()==_1&&_2.getDate()==_3"
                                                        }
                                                    } ],
                                                    "v": {
                                                        "click": "setDate"
