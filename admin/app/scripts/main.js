        ...
        dataType: "html"
            ...
            table = new Table({
                ...
                data: {
                    ...
                    table: "users",
                    tables: ["users", "other", "orders", "MeantToCauseAlert", "settings", "tablesPrimaryKeys", "symbols", "quickOrdersPizza", "quickOrdersSalad", "quickOrdersWings", "quickOrdersDrink", "pizzaHeadings", "ingredients"]
                }
            });
            var func = function() {
                table.switchTable({
