        ...
        dataType: "html"
            ...
            table = new Table({
                ...
                data: {
                    ...
                    table: "users",
                    tables: ["users", "other", "orders", "MeantToCauseAlert", "tablesPrimaryKeys", "symbols", "quickOrdersPizza", "quickOrdersSalad", "quickOrdersWings", "quickOrdersDrink", "possibleChoices", "choiceHeadings"]
                }
            });
            var func = function() {
                table.switchTable({
